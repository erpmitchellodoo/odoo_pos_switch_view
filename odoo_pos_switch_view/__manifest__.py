...
* Existing product selection, product prices and information controls, search and categories.
* View preference saved per POS configuration in the current browser.
* Responsive layout for desktop and smaller screens.

Requires Odoo 17 Point of Sale and a deployment supporting custom addons.
